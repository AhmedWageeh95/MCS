...
public class doctor extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_profile_patient) {
            startActivity(new Intent(this,profile_doctor.class));


        } else if (id == R.id.nav_home_patient) {
            startActivity(new Intent(this,doctor.class));

        } else if (id == R.id.nav_search_patient) {
            startActivity(new Intent(this,Searchpatient.class));


        } else if (id == R.id.nav_my_care_patient) {
            startActivity(new Intent(this,MyCare
                    .class));


        } else if (id == R.id.nav_about_patient) {
            startActivity(new Intent(this,About.class));


        } else if (id == R.id.nav_setting_patient) {
